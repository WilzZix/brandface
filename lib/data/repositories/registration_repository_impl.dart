...
class RegistrationRepositoryImpl implements IRegistrationRepository {
  ...
  RegistrationRepositoryImpl({required RegistrationDataSource dataSource}) : _dataSource = dataSource;

  @override
  Future<Either<Failures, RegistrationEntity>> registration({required RegistrationParams params}) async {
    try {
